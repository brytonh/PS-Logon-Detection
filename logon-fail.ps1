...
$message=Get-EventLog -LogName Security -Computer $env:computername -InstanceID 4625 | select message | format-list | findstr /c:"Account Name" | Sort-Object | Get-Unique
